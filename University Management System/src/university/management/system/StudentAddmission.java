...
class StudentAddmission implements ActionListener{
    ...
    public StudentAddmission(){
        ...
        f = new JFrame("Student Addmission");
        ...
        lb8 = new JLabel("New Student Details");
        ...
        lb9 = new JLabel("Class X(%):");
        lb9.setBounds(400, 300, 130, 30);
        ...
        lb10 = new JLabel("Class XII(%):");
        lb10.setBounds(50, 350, 150, 30);
        ...
        lb11 = new JLabel("Aadhar No.:");
        lb11.setBounds(400, 350, 130, 30);
        ...
        lb12 = new JLabel("Roll No.:");
        lb12.setBounds(50, 400, 150, 30);
        lb12.setFont(new Font("Sitka Text", Font.BOLD, 18));
        lb15.add(lb12);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == btn){
            try{
                Conn cc = new Conn();
                String q = "insert into addstudent values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+l+"','"+m+"')";
    ...
    public static void main(String[ ] arg){
        new StudentAddmission().f.setVisible(true);
    }
}