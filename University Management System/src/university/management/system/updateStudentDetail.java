...
class updateStudentDetail implements ActionListener {
    ...
    updateStudentDetail() {;
        ...
        id5.setFont(new Font("sitk text", Font.BOLD, 18));
        f.add(id5);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b) {
            try {
                Conn con = new Conn();
                String str = "update addstudent set name='" + t1.getText() + "',father_name='" + t2.getText() + "',age='" + t3.getText() + "', dob='" + t4.getText() + "',addr='" + t5.getText() + "',phone='" + t6.getText() + "',email='" + t7.getText() + "',class_x='" + t8.getText() + "',class_xii='" + t9.getText() + "',addhaar='" + t10.getText() + "',course='" + t13.getText() + "',branch='" + t14.getText() + "' where roll='" + t12.getText() + "'";
        ...
        if (ae.getSource() == b2) {
            try {
                Conn con = new Conn();
                String str = "select * from addstudent where roll = '" + t12.getText() + "'";
    ...
    public static void main(String[] arg) {
        new updateStudentDetail().f.setVisible(true);
    }
}
