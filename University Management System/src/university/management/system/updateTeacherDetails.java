...
class updateTeacherDetails implements ActionListener {
    ...
    updateTeacherDetails() {
        ...
        l1.setFont(new Font("sitka text", Font.BOLD, 20));
        f.add(l1);

        t12 = new JTextField();
        t12.setBounds(550, 100, 200, 30);
        f.add(t12);
        ...
        id8.setFont(new Font("sitka text", Font.BOLD, 35));
        id8.setForeground(Color.black);
        f.add(id8);

        id1 = new JLabel("Name:");
        id1.setBounds(50, 170, 100, 30);
        id1.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id1);
        ...
        id2.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id2);
        ...
        id3.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id3);
        ...
        id4.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id4);
        ...
        id5.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id5);
        ...
        id6.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id6);
        ...
        id7.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id7);
        ...
        id9.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id9);
        ...
        id10.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id10);
        ...
        id11.setBounds(400, 370, 130, 30);
        id11.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id11);
        ...
        id12.setFont(new Font("sitka text", Font.BOLD, 18));
        f.add(id12);
        ...
        b.setBackground(new Color(15, 19, 42));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b) {
            try {
                Conn con = new Conn();
                String str = "update addteacher set name='" + t1.getText() + "',father_name='" + t2.getText() + "',age='" + t3.getText() + "', dob='" + t4.getText() + "',addr='" + t5.getText() + "',phone='" + t6.getText() + "',email='" + t7.getText() + "',class_x='" + t8.getText() + "',class_xii='" + t9.getText() + "',aadhaar='" + t10.getText() + "', emp_id = '" + t11.getText() + "',qual='" + t13.getText() + "',dept='" + t14.getText() + "' where emp_id='" + t12.getText() + "'";
        ...
        if (ae.getSource() == b2) {
            try {
                Conn con = new Conn();
                String str = "select * from addteacher where emp_id = '" + t12.getText() + "'";
            ...
            f.setVisible(true);
            f.setSize(900, 650);
            f.setLocation(250, 700);
        }
    }

    public static void main(String[] arg) {
        new updateTeacherDetails().f.setVisible(true);
    }
}
