...
public class StudentDetails extends JFrame implements ActionListener{
    ...
    StudentDetails(){
        ...
        l2.setFont(new Font("sitka text",Font.BOLD,20));
        add(l2);
        ...
        l3.setFont(new Font("sitka text",Font.BOLD,20));
        add(l3);
        
        b3 = new JButton("Update Student");
        b3.setBackground(new Color(15,19,42));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b1){
            try{
                String a = t2.getText();
                String q = "delete from addstudent where roll = '"+a+"'";
            ...
            new updateStudentDetail().setVisible(true); //change UpdateDetails later
            this.setVisible(false);
        }
    }
